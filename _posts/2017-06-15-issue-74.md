...
Roman Levenstein [cherry-picked a patch](https://github.com/apple/swift/pull/10263) from master to the Swift 4 branch that reduces the standard library code size by about 5%-6%.
