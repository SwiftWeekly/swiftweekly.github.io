...
The last two weeks have passed very quickly. I volunteered to help my country plan the project to develop an information system to distribute and vaccinate people against Covid-19. I hope everything turns out smoothly as it can.

I want to say thank you to people and companies that have reached out and are willing to sponsor this project. Thank you for that! There are free spots for you to [support this newsletter](/sponsorship) and project to cover the running costs.

Lately, we have seen a rapid increase in new proposals from the community. Mostly it is great to see that new folks are joining and expressing their ideas. Now let's get to the news.
...
[Soroush Khanlou](https://twitter.com/khanlou) wrote [a blog post](https://khanlou.com/2021/01/meridian/) about launching [Meridian](https://github.com/khanlou/Meridian/) - web server written in Swift that lets you write your endpoints in a declarative way.
...
Great article exlaining how to [render Moana with Swift](https://gonsoloblog.wordpress.com/2021/01/14/rendering-moana-with-swift/). It's worth reading the Hacker News [thread](https://news.ycombinator.com/item?id=25779611) which contains a lot of valuable insights.
