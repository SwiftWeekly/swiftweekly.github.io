...
{% include indie_support_weeks.html link="https://sundialapp.com" heading="Sundial" body="Sundial provides a one-of-a-kind display of the sun and moon rise/set cycle over the 24 hour day. Key event times are displayed, such as sunrise, moonset, and days to next full and new moon." displaylink="sundialapp.com" %}
