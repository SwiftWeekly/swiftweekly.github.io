...
[Jeroen Leenarts](https://twitter.com/AppForce1) and I teamed up to improve the mailing list platform we're using to send out this newsletter, and hopefully cut costs. This week is the first real test. If this email finds your mailbox, then we know it's working. :)

I want to thank all the supporters, sponsors and everyone in the Swift community who help make this project happen. If you have any ideas about things to change, improve upon, or to better [support this newsletter financially](https://swiftweekly.github.io/sponsorship/), please [let me know](mailto:fassko@gmail.com).
