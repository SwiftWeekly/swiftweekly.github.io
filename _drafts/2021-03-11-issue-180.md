...
Another two weeks passed in a blink. I have been busy launching my new project into the wild, receiving harsh feedback from customers, and improving it.

[Jeroen](https://twitter.com/AppForce1) and I teamed up to improve and cut the costs for the email sending platform we're using to send out this newsletter. This week is the first real test. If this email finds your mailbox, then we know it is working. :)

I want to thank you again for all the supporters, sponsors and everyone in the Swift community who help make this project happen. If you have any ideas, what to change, improve or support this newsletter financially, [let me know](https://swiftweekly.github.io/sponsorship/).
