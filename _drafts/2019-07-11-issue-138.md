...
[Artem Redkin](https://twitter.com/artemredkin) and other contributors released a [1.0.0-alpha.1 of AsyncHTTPClient](https://github.com/swift-server/async-http-client) tagged, a Swift NIO2 based HTTP client recently approved to 'sandbox' by the Swift Server Work Group.
...
[Xiaodi Wu](https://twitter.com/xwu) merged a [PR](https://github.com/apple/swift/pull/25745) that helps top reorganize Decimal.swift, bringing the two implementations back into alignment. This resolves [SR-3126](https://github.com/apple/swift/pull/25745).
