...
* getting into holiday schedule https://forums.swift.org/t/holiday-schedule/53507
* in Xcode 13.2 beta new build system makes build times much faster by using more CPU cores https://developer.apple.com/documentation/xcode-release-notes/xcode-13_2-release-notes#Build-System
* thank you for sponsoring this project for rest of the year
