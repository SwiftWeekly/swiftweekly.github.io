...
We are ending this year with two notable initiatives. The [Diversity in Swift](https://swift.org/blog/diversity-in-swift/) workgroup will include posts on the Swift.org blog that recognize and highlight the work being done by developers across our community. The Diversity in Swift workgroup will use the [Community Showcase](https://forums.swift.org/c/community-showcase) to brainstorm ideas and topics for these community-focused blog posts. [Accessibility](https://swift.org/blog/accessibility-and-inclusion/) is a crucial consideration when building truly inclusive software and when working to foster a diverse community. We want everyone in our community to share the same passion for making apps and experiences accessible and inclusive to all.
