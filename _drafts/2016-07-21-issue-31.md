...
Brian Gesiak has [hacked together](http://modocache.io/nuclide-swift-ide) Swift support for the [Nuclide](https://nuclide.io) IDE! 🤓 It's still a work-in-progress and you couldn't replace Xcode yet, but if you're looking for a Swift IDE on Linux then you're in luck. 👌
