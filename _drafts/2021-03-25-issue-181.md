...
I would like to personally say thank you to [Jeroen Leenarts](https://twitter.com/AppForce1) for his tremendous help in setting up a new email marketing platform. We have a fantastic new domain: [swiftweeklybrief.com](https://swiftweeklybrief.com/).

Great news about the *Actors* proposal which is now [under review](https://forums.swift.org/t/se-0306-actors/45734https://forums.swift.org/t/se-0305-package-manager-binary-target-improvements/45589). Some vast improvements are coming to Swift later this year!

There are so many [great pitches](https://forums.swift.org/tag/gsoc-2021) for this year's Google Summer of Code for the Swift language. Some of these are going to be implemented during the summer by university students.
