...
Exactly on this day, five years ago, Apple open-sourced Swift programming language! Imagine how fast this language has moved and what will the next five years bring? 🎂🥳🎊

We have some excellent news for server-side Swift development. Starting with the introduction of [SwiftNIO SSH](https://swift.org/blog/swiftnio-ssh/) and [early version of docker](https://twitter.com/morlhon/status/1332609373051478016) desktop running on Apple Silicon. On top of that, we have [Mac instances for EC2](https://developer.apple.com/news/?id=swfemvx0) now available from [Amazon Web Services](https://aws.amazon.com/blogs/aws/new-use-mac-instances-to-build-test-macos-ios-ipados-tvos-and-watchos-apps/). I think that opens even more doors for Swift language being available to build great products!
...
[James Dempsey](https://twitter.com/jamesdempsey) announced a new project - [Swift Version](https://swiftversion.net/) - website that shows which Swift shipped with which Xcode.

[Mishal Shah](https://twitter.com/mishaldshah) announced the [Swift Platform Support](https://swift.org/platform-support) - a central hub of what tools and capabilities are available on specific platforms for the development and deployment of Swift applications.
