...
It's great to see so much work being done so soon after WWDC. The Core Team and Core Contributors are making significant progress on the road to the offical Swift 4 launch.
...
The Swift Man Page [got an update](https://github.com/apple/swift/pull/10241).
...
David Farler [merged a pull request](https://github.com/apple/swift-clang/pull/95) that upstreams previous Apple Internal index-while-building changes released in the Xcode 9 timeframe. From Brian Gesiak on these changes:

> Apple developed index-while-building on their internal Clang fork in time for Xcode 9. The changes are being merged to swift-clang, the Swift project's fork of Clang, in apple/swift-clang. 87 files changed, 9,127 lines added, 30 lines deleted!. As far a I can tell, there isn't a diff up for this on the upstream Clang repository..."
