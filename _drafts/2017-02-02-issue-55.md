...
Graydon Hoare ([@graydon](https://github.com/graydon)) opened a [pull request](https://github.com/apple/swift/pull/7088) to fix an issue in the constraint solver where it was inaccurately measuring is memory usage threshold.
