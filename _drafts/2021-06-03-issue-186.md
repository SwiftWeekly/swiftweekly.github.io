...
Swift Trunk (main) nightly development Ubuntu 20.04 aarch64 Snapshots [available](https://swift.org/download/#snapshots)!

### Commits and pull requests

* [Andrew Trick](https://github.com/atrick) made [a pull request](fixes correctness bugs that are blocking other optimization bug fixes).
