...
The last two weeks passed for me so quickly, lately being very busy with a new project that I'm launching this week and exploring SwiftUI.
...
Thank you for your support and help to support this newsletter. We are looking for all kinds of help - [financial](/sponsorship/), putting together new issue or [contributiong](https://github.com/SwiftWeekly/.github/blob/master/CONTRIBUTING.md) to improving the site. Thank you, now straight to the news!
...
[George](https://forums.swift.org/u/george) purposed [a solution](https://forums.swift.org/t/new-de-en-codingcontainer-types-to-support-enums-with-associated-types-and-tuples/44647) how to fix the issue of automatic `Codable` synthesis for enums with associated types.
